                    ...
                    <?php foreach ($carts as $cart) : ?>
                        <div class="row mb-5">
                            <div class="col-12 col-sm-7">
                                <div class="d-flex gap-5">
                                    ...
                                    <div class="d-flex flex-column justify-content-center gap-3 py-4">
                                        ...
                                        <?php endif; ?>
                                        <span class="fs-4 fw-semibold">£<?= $cart['price'] - ($cart['price'] * $cart['discount'] / 100); ?></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-sm-2 d-flex">
                                ...
                                ?>
                                <span class="my-auto ms-auto me-0 fw-bold">₤<?= number_format($productPrice, 2, '.', ',') ?></span>
                            </div>
                        </div>
                    <?php endforeach; ?>
                    <button type="submit" name="btnUpdateCart" class="btn btn-outline-success px-4 py-2 mt-5 fs-4 fw-semibold float-end">UPDATE CART</button>
                </form>
            </div>
            ...
            <div class="col-12 col-lg-4">
                <div class="border bg-light">
                    ...
                    <div class="px-4 py-5 d-flex flex-column gap-5">
                        ...
                        <div class="btn btn-danger fs-4 fw-semibold w-100">CHECK OUT</div>
                        ...
                        <div class="d-flex justify-content-evenly">
                            <div class="momo">
                                <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 296 296" style="enable-background:new 0 0 296 296;" xml:space="preserve">
                                    <style type="text/css">
                                        .st0 {
                                            fill-rule: evenodd;
                                            clip-rule: evenodd;
