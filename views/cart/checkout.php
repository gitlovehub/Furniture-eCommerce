        ...
        <div class="row d-flex gap-5">
            <div class="col-12 col-sm-5">
                ...
                <div class="mb-5 fs-4">
                    ...
                    <div class="payment-box mb-3 d-flex align-items-center border ps-4" style="height: 50px;" onclick="toggleCheckbox('bank')">
                        <div class="form-check lh-base">
...
<script>
    function toggleCheckbox(id) {
        ...
        checkboxes.forEach(function(checkbox) {
            // Uncheck checkboxes that are not clicked
            if (checkbox.id !== id) {
        ...
        // Loop through all payment boxes
        paymentBoxes.forEach(function(paymentBox) {
            // Remove 'choose' class from all payment boxes
            paymentBox.classList.remove('choose');
        });

        // Add 'choose' class to the payment box associated with the clicked checkbox
        const paymentBox = checkBox.closest('.payment-box');
        if (checkBox.checked) {
            paymentBox.classList.add('choose');
        }
    }
</script>