                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea rows="6" cols="50" name="productDescription" class="form-control" id="product-description" 
                                placeholder="Enter description here"><?= $show['description'] ?></textarea>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="product-category" name="productCategory">
                                <?php foreach ($listCategory as $value) : ?>
                                    <option <?= $value['id'] == $show['id_category'] ? 'selected' : '' ?>
                                    value="<?= $value['id'] ?>">
                                        <?= $value['name'] ?>
                                    </option>
                                <?php endforeach; ?>
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="number" min="0" name="productPrice" class="form-control" id="product-price" value="<?= $show['price'] ?>" placeholder="1000">
                            </div>
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="product-discount">Discount percent</label>
                            <div class="input-group">
                                <input type="number" min="0" max="100" name="productDiscount" class="form-control" id="product-discount" value="<?= $show['discount'] ?>" placeholder="10">
                                <span class="input-group-text">%</span>
                            </div>
                        </div>
                    </div>
